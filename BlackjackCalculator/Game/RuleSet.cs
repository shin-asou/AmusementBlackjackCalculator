...
namespace BlackjackCalculator.Game
{
    ...
    public class RuleSet(bool isStandValueDealerSoftHand, bool canDoubledownAfterSplit, int maxSplit, bool canResplitAces, bool canHitSplitAces, bool isMadeBySplitBlackjackNatural, DoubledownType doubledown, SurrenderType surrenderType, FrozenDictionary<GameResult, ResultPayout> payoutTable, int deckCount, int endDeckCount)
    {
        ...
        public bool IsMadeBySplitBlackjackNatural { get; } = isMadeBySplitBlackjackNatural;
